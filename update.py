...
if not BOT_TOKEN:
    log_error("La variable BOT_TOKEN est manquante ! Sortie en cours")
    exit(1)
...
if UPSTREAM_REPO:
    ...
    if update.returncode == 0:
        log_info("Mis à jour avec succès avec le dernier commit de UPSTREAM_REPO")
    else:
        log_error(
            "Quelque chose s'est mal passé lors de la mise à jour, vérifiez si UPSTREAM_REPO est valide ou non !"
        )